...
/* harmony import */ var _library_library_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./library/library.component */ "./src/app/library/library.component.ts");
...
/* harmony import */ var _shared_google_books_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./shared/google-books.service */ "./src/app/shared/google-books.service.ts");
/* harmony import */ var _pager_pager_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./pager/pager.component */ "./src/app/pager/pager.component.ts");
/* harmony import */ var _shared_library_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./shared/library.service */ "./src/app/shared/library.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _library_library_component__WEBPACK_IMPORTED_MODULE_10__["LibraryComponent"],
                _pager_pager_component__WEBPACK_IMPORTED_MODULE_14__["PagerComponent"]
            ],
            imports: [
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_11__["RouterModule"].forRoot(_app_routes__WEBPACK_IMPORTED_MODULE_12__["routes"]),
                _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModule"].forRoot()
            ],
            providers: [_shared_google_books_service__WEBPACK_IMPORTED_MODULE_13__["GoogleBooksService"], _shared_library_service__WEBPACK_IMPORTED_MODULE_15__["LibraryService"]],
...
var BookComponent = /** @class */ (function () {
    ...
    BookComponent.prototype.ngOnInit = function () {
        console.log('I am being initiated');
    };
    ...
    BookComponent.prototype.goToUrl = function () {
        // alert(this.book.buyLink);
        // window.open(this.book.buyLink, "_blank");
        // location.href = this.book.buyLink;
    };
    ...
    BookComponent.prototype.removeBook = function (book) {
        if (book) {
            ...
            this.newrouter.navigate(["library"]);
        }
    };
...
module.exports = "<ngb-pagination (pageChange)=\"onPager($event)\" [rotate]=\"true\" [ellipses]=\"false\"\n                                            [maxSize]=\"10\" [collectionSize]=\"totalPages\" [pageSize]=\"1\"\n                                            [(page)]=\"page\" size=\"sm\"></ngb-pagination>"
...
var PagerComponent = /** @class */ (function () {
    ...
    */
    ...
    PagerComponent.prototype.onPager = function (event) {
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.onSearch = function (term) {
        ...
        this.booksList = this.googleBooksService.books;
    };
...
var Book = /** @class */ (function () {
    function Book(id, title, subTitle, authors, publisher, publishDate, description, categories, thumbnail, smallThumbnail, buyLink) {
        this.id = id;
        this.title = title;
...
/* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm5/http.js");
/* harmony import */ var _book__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./book */ "./src/app/shared/book.ts");
...
var GoogleBooksService = /** @class */ (function () {
    ...
    GoogleBooksService.prototype.retrieveBook = function (bookId) {
        ...
        return this.http.get(this.API_PATH + "/" + bookId)
            .map(function (res) { return res.json(); })
            .do(function (item) { return console.log("Retrieve Item SaleInfor" + item.saleinfo); })
            .map(function (item) { return _this.bookFactory(item); });
    };
    GoogleBooksService.prototype.bookFactory = function (item) {
        return new _book__WEBPACK_IMPORTED_MODULE_4__["Book"](item.id, item.volumeInfo.title, item.volumeInfo.subtitle, item.volumeInfo.authors, item.volumeInfo.publisher, item.volumeInfo.publishedDate, item.volumeInfo.description, item.volumeInfo.categories ? item.volumeInfo.categories.map(function (item) { return item.split("/").pop().trim(); }) : ['N/A'], item.volumeInfo.imageLinks.thumbnail, item.volumeInfo.imageLinks.smallThumbnail, item.saleInfo.buyLink);
    };
...
var LibraryService = /** @class */ (function () {
    ...
    LibraryService.prototype.load = function () {
        ...
        for (var i = 0; i < savedBooks.length; i++) {
            ...
            this.books.push(Object.assign(new _book__WEBPACK_IMPORTED_MODULE_1__["Book"](null, null, null, null, null, null, null, null, null, null, null), savedBook));
        }
    };
...
module.exports = __webpack_require__(/*! /home/rahulkumar/AngualrProj/BookProj/src/main.ts */"./src/main.ts");
